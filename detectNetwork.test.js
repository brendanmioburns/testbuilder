...
describe('Diner\'s Club', function() {
  ...
  it('has a prefix of 38 and a length of 14', function() {
    if (detectNetwork('38123456789012') !== 'Diner\'s Club') {
...
describe('MasterCard', function() {
  ...
  it('it has a prefix of 51', function() {
    expect(detectNetwork('5112345678901234')).to.equal('MasterCard');
  });
  it('it has a prefix of 52', function() {
    expect(detectNetwork('5212345678901234')).to.equal('MasterCard');
  });
  it('if has a prefix of 53', function() {
  ...
  for (var prefix = 644; prefix <= 649; prefix++) {
    (function(prefix) {
      it('has a prefix of ' + prefix + ' and a length of 16', function() {
        assert(detectNetwork(prefix.toString() + "1234567890123") === 'Discover');
      });
      it('has a prefix of ' + prefix + ' and a length of 19', function() {
        assert(detectNetwork(prefix.toString() + '1234567890123456') === 'Discover');
      });
    })(prefix);
  }
...
describe('Maestro', function() {
  ...
  it('has a prefix of 5018 and a length of 12', function() {
    expect(detectNetwork('501823945823')).to.equal('Maestro');
  });
  it('has a prefix of 5018 and a length of 13', function() {
    expect(detectNetwork('5018239458234')).to.equal('Maestro');
  });
  it('has a prefix of 5018 and a length of 14', function() {
    expect(detectNetwork('50182394582345')).to.equal('Maestro');
  });
  it('has a prefix of 5018 and a length of 15', function() {
    expect(detectNetwork('501823945823456')).to.equal('Maestro');
  });
  it('has a prefix of 5018 and a length of 16', function() {
    expect(detectNetwork('5018239458234567')).to.equal('Maestro');
  });
  it('has a prefix of 5018 and a length of 17', function() {
    expect(detectNetwork('50182394582345678')).to.equal('Maestro');
  });
  it('has a prefix of 5018 and a length of 18', function() {
    expect(detectNetwork('501823945823456789')).to.equal('Maestro');
  });
  it('has a prefix of 5018 and a length of 19', function() {
    expect(detectNetwork('5018239458234567890')).to.equal('Maestro');
  });
